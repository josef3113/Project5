...
namespace Project5
{
    class DamkaGame
    {
        ...
        public string[] m_BoardOfGame;   // need to be private 
        ...
        private string[] CreatBoard()
        {
            ...
            string[] stringBaord = new string[2 * m_SizeOfBoardGame + 1];
            ...
            stringBaord[0] = colSign.ToString();
            StringBuilder linesOfBoard = new StringBuilder();
            for (int i = 1; i < 2 * m_SizeOfBoardGame + 1; i += 2)
            {
                stringBaord[i] = lineBuffer.ToString();    // check this 
            }
            ...
            for (int i = 0; i < m_SizeOfBoardGame; i++)
            {
                ...
                linesOfBoard.Append("|");
                stringBaord[currentLine] = linesOfBoard.ToString();
                currentLine += 2;
                signRow++;
            }
        ...
        public  void PrintBoardGame()
        {
           // Ex02.ConsoleUtils.Screen.Clear();
            for (int i = 0; i < 2*m_SizeOfBoardGame +1 ; i ++)
            {
        ...
        //    {
        //        //todo
        //        return m_BoardOfGame[i_Row][ i_Row - 'A'];
        //    }
        //    set
        //    {
